...
static if REFORGED_MODE then
    return BlzGetUnitDiceNumber(whichUnit, weaponIndex)
else
...
static if REFORGED_MODE then
    call BlzSetUnitDiceNumber(whichUnit, diceNumber, weaponIndex)
else
    if weaponIndex == 1 then
...
static if REFORGED_MODE then
    return BlzGetUnitDiceSides(whichUnit, weaponIndex)
else
    if weaponIndex == 1 then
...
static if REFORGED_MODE then
    call BlzSetUnitDiceSides(whichUnit, diceSides, weaponIndex)
else
    if weaponIndex == 1 then
...
static if REFORGED_MODE then
    call BlzSetUnitBaseDamage(whichUnit, baseDamage, weaponIndex)
else
    if weaponIndex == 1 then
...
static if REFORGED_MODE then
    return BlzGetUnitAttackCooldown(whichUnit, weaponIndex)
else
    if weaponIndex == 1 then
...
static if REFORGED_MODE then
    call BlzSetUnitAttackCooldown(whichUnit, cooldown, weaponIndex)
else
    if weaponIndex == 1 then
...
static if REFORGED_MODE then
    return BlzGetUnitWeaponIntegerField(whichUnit, UNIT_WEAPON_IF_ATTACK_WEAPON_SOUND, index)
else
    if index == 1 then
...
static if REFORGED_MODE then
    call BlzSetUnitWeaponIntegerField(whichUnit, UNIT_WEAPON_IF_ATTACK_WEAPON_SOUND, index, value)
else
    if index == 1 then
...
static if REFORGED_MODE then
    return BlzGetUnitWeaponIntegerField(whichUnit, UNIT_WEAPON_IF_ATTACK_ATTACK_TYPE, index)
else
    if index == 1 then
...
static if REFORGED_MODE then
    call BlzSetUnitWeaponIntegerField(whichUnit, UNIT_WEAPON_IF_ATTACK_ATTACK_TYPE, index, value)
else
    if index == 1 then
...
static if REFORGED_MODE then
    return BlzGetUnitWeaponIntegerField(whichUnit, UNIT_WEAPON_IF_ATTACK_MAXIMUM_NUMBER_OF_TARGETS, index)
else
    if index == 1 then
...
static if REFORGED_MODE then
    call BlzSetUnitWeaponIntegerField(whichUnit, UNIT_WEAPON_IF_ATTACK_MAXIMUM_NUMBER_OF_TARGETS, index, value)
else
    if index == 1 then
...
static if REFORGED_MODE then
    return BlzGetUnitWeaponIntegerField(whichUnit, UNIT_WEAPON_IF_ATTACK_TARGETS_ALLOWED, index)
else
    if index == 1 then
...
static if REFORGED_MODE then
    call BlzSetUnitWeaponIntegerField(whichUnit, UNIT_WEAPON_IF_ATTACK_TARGETS_ALLOWED, index, value)
else
    if index == 1 then
...
static if REFORGED_MODE then
    return BlzGetUnitWeaponRealField(whichUnit, UNIT_WEAPON_RF_ATTACK_DAMAGE_LOSS_FACTOR, index)
else
    if index == 1 then
...
static if REFORGED_MODE then
    call BlzSetUnitWeaponRealField(whichUnit, UNIT_WEAPON_RF_ATTACK_DAMAGE_LOSS_FACTOR, index, value)
else
    if index == 1 then
...
static if REFORGED_MODE then
    return BlzGetUnitWeaponRealField(whichUnit, UNIT_WEAPON_RF_ATTACK_RANGE, index)
else
    if index == 1 then
...
static if REFORGED_MODE then
    call BlzSetUnitWeaponRealField(whichUnit, UNIT_WEAPON_RF_ATTACK_RANGE, index, value)
else
    if index == 1 then
...
static if REFORGED_MODE then
    return BlzGetUnitWeaponRealField(whichUnit, UNIT_WEAPON_RF_ATTACK_DAMAGE_SPILL_DISTANCE, index)
else
    if index == 1 then
...
static if REFORGED_MODE then
    call BlzSetUnitWeaponRealField(whichUnit, UNIT_WEAPON_RF_ATTACK_DAMAGE_SPILL_DISTANCE, index, value)
else
    if index == 1 then
...
static if REFORGED_MODE then
    return BlzGetUnitWeaponRealField(whichUnit, UNIT_WEAPON_RF_ATTACK_DAMAGE_SPILL_RADIUS, index)
else
    if index == 1 then
...
static if REFORGED_MODE then
    call BlzSetUnitWeaponRealField(whichUnit, UNIT_WEAPON_RF_ATTACK_DAMAGE_SPILL_RADIUS, index, value)
else
    if index == 1 then
...
static if REFORGED_MODE then
    return BlzGetUnitWeaponRealField(whichUnit, UNIT_WEAPON_RF_ATTACK_BACKSWING_POINT, index)
else
    if index == 1 then
...
static if REFORGED_MODE then
    call BlzSetUnitWeaponRealField(whichUnit, UNIT_WEAPON_RF_ATTACK_BACKSWING_POINT, index, value)
else
    if index == 1 then
...
static if REFORGED_MODE then
    return BlzGetUnitWeaponRealField(whichUnit, UNIT_WEAPON_RF_ATTACK_DAMAGE_POINT, index)
else
    if index == 1 then
...
static if REFORGED_MODE then
    call BlzSetUnitWeaponRealField(whichUnit, UNIT_WEAPON_RF_ATTACK_DAMAGE_POINT, index, value)
else
    if index == 1 then
