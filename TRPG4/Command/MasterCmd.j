library MasterCmd uses Controller
    ...
    private function Test2Cmd takes nothing returns boolean
        ...
        set x = (CenterX + 0.08) + s2r(GetArgs(2))
        //set y = s2r(GetArgs(3))
        //call BJDebugMsg(R2S(s2r(GetArgs(2))))
        call JNFrameSetAbsPoint(TestHandler, JN_FRAMEPOINT_TOPRIGHT, x, CenterY + 0.01)
        //call BJDebugMsg(R2SW(value, 10, 10))
